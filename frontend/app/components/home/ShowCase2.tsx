...
export default function ShowCase2() {
  ...
  const desktopImage =
    "/home-imgs/showcase2/showcase2_PC.png";
  const mobileImage =
    "/home-imgs/showcase2/showcase2_mobile.png";

  return (
    <div className="flex flex-col overflow-hidden pb-[200px] pt-[100px] md:pt-[150px]" style={{ backgroundColor: colors.bg.primary }}>
      <div
        ref={containerRef}
