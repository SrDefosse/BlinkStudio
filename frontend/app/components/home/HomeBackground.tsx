...
export default function HomeBackground({ children }: HomeBackgroundProps) {
    ...
    return (
      ...
      `}</style>
            <div className="min-h-screen bg-gradient-to-br from-[#1a1d18] via-black to-[#2a2e26] text-[#e6e1d7] font-primary relative w-full">
                ...
                <div className="fixed inset-0 pointer-events-none z-0">
                    ...
                    {/* Corner elements - using fixed position */}
